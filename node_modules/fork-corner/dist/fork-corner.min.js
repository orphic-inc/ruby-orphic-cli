...
const fchead=document.getElementsByTagName("head")[0],fcController=document.getElementById("fork-corner"),fcIcon=document.createElement("i"),fcDevicon=document.createElement("link");fcDevicon.rel="stylesheet",fcDevicon.type="text/css",fcDevicon.href="https://cdn.jsdelivr.net/gh/devicons/devicon@master/devicon.min.css";const fcElement=document.createElement("div");document.querySelector(".fc-theme-default")&&fcIcon.setAttribute("class","devicon-git-plain"),document.querySelector(".fc-theme-github")&&fcIcon.setAttribute("class","devicon-github-plain"),document.querySelector(".fc-theme-gitlab")&&fcIcon.setAttribute("class","devicon-gitlab-plain"),document.querySelector(".fc-theme-bitbucket")&&fcIcon.setAttribute("class","devicon-bitbucket-plain"),fchead.appendChild(fcDevicon),fcController.appendChild(fcIcon),fcController.parentNode.insertBefore(fcElement,fcController.nextSibling);